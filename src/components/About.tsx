...
export default function About() {
  const highlights = [
    { icon: <Code className="w-6 h-6 text-indigo-500" />, label: 'Frontend', desc: 'Vue.js, React, Tailwind' },
    { icon: <Server className="w-6 h-6 text-purple-500" />, label: 'Backend', desc: 'Laravel, PHP, REST APIs' },
    { icon: <Database className="w-6 h-6 text-pink-500" />, label: 'Database', desc: 'MySQL, Redis' },
    { icon: <Cloud className="w-6 h-6 text-emerald-500" />, label: 'DevOps', desc: 'Docker, AWS, CI/CD' },
  ];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
        <div className="space-y-6">
          <h3 className="text-3xl font-display font-medium text-slate-800 dark:text-slate-200 leading-tight">
            I craft digital experiences with a focus on <span className="font-bold text-indigo-500">performance</span> and <span className="font-bold text-purple-500">scalability</span>.
          </h3>
          ...
          <div className="grid grid-cols-2 gap-8 pt-8">
            <div className="p-6 rounded-3xl glass text-center">
               <p className="text-4xl font-black text-slate-900 dark:text-white mb-2">3.5+</p>
               <p className="text-sm font-medium uppercase tracking-wider text-slate-500">Years Exp</p>
            </div>
            <div className="p-6 rounded-3xl glass text-center">
               <p className="text-4xl font-black text-slate-900 dark:text-white mb-2">30+</p>
               <p className="text-sm font-medium uppercase tracking-wider text-slate-500">Projects</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {highlights.map((item, idx) => (
            ...
            >
              ...
              <p className="text-sm text-slate-600 dark:text-slate-400 font-medium">{item.desc}</p>
            </motion.div>
          ))}
        </div>
      </div>
